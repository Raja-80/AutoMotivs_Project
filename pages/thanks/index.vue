  ...
  <div class="container">
    <div class="flex flex-col items-center gap-5 py-24 text-center md:gap-6 lg:gap-7">
        ...
        <h1 class="text-4xl font-bold sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-primary">
            <span data-aos="fade-up">{{ $settings.sections.thanks.title }}</span>
        </h1>
        <!-- title -->

        <!-- orderCode -->
        <div data-aos="fade-up" class="flex items-center justify-center px-4 py-1 text-base bg-gray-100 rounded-full" v-if="orderCode">
        ...
        <!-- text thank you -->
        <p data-aos="fade-up" class="text-2xl font-semibold text-gray-700 md:text-3xl lg:text-4xl">{{ $settings.sections.thanks.description }}</p>
        <!-- text thank you -->

        <!-- button -->
        <nuxt-link data-aos="fade-up" to="/shop" class="inline-flex px-4 py-2.5 text-sm font-medium tracking-wider rounded-full shadow-sm md:px-6 md:py-3 bg-primary text-gray-50 hover:shadow-lg"> 
